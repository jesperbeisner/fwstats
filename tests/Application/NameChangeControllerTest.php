...
#[CoversClass(NameChangeController::class)]
final class NameChangeControllerTest extends AbstractTestCase
{
    ...
    {
        $request = new Request(['REQUEST_URI' => '/changes/names', 'REQUEST_METHOD' => 'GET'], [], [], [], []);
        ...
        $this->assertSame('changes/names.phtml', $response->template);
